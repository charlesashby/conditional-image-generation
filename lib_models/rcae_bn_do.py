...
# Implementation of a residual convolutional autoencoder with
# batch norm and drop out, the skip connections are implementated like
...
class AutoEncoder(object):
    ...
    def build_model(self):
        ...
        def AutoEncoder(X):
            ...
            dense_layer = MLP_do(conv2, flatten=True, W_hidden=p['W_hidden'],
    ...
    def train_model(self):
        ...
        while epoch < n_epochs and not DONE_LOOPING:
            ...
            if validation_loss < best_validation_loss:
                ...
                # Save the model
                print('Saving...')
                self.save('model_rcae_bn_do.pkl')
                # -------------
...
if __name__ == '__main__':
    ...
    network.train_model()
    """
    from lib_models.drcae_bn_do import *
    network = AutoEncoder()
    network.build_model()
    network.load('Models/model_rcae_bn_do.pkl')
    t = network.generate()
